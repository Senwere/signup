...
//     const visibleSection = document.querySelector('section:not([style*="none"])');

//     // Hide the current section
//     visibleSection.style.display = 'none';

//     // Show the next section
//     const nextSection = visibleSection.nextElementSibling;
//     if (nextSection) {
...
//       const sectionMaxHeight = windowHeight - footerOffset;

//       section.style.maxHeight = ''; // Reset max-height property

//       if (contentHeight > sectionMaxHeight) {
...
//     names.innerHTML = '';
//     // Update the login status on the page
//     let loginButton = document.querySelector(".loginInButton");
//     loginButton.innerHTML = '<a onclick="showLogin(event)" href="#">Login</a>';
//   }
...
//   // Attach the event listener to the tracking button
